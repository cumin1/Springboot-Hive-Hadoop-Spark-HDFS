<template>
  <div class="box">
    <h1>txt list</h1>
    <ul class="file-list">
      <li class="list-item" v-for="txt in txts" :key="txt" @click="handleClick(txt)">
        {{ txt }} <button class="delete-btn" :data-image-name="image" @click.stop="handleDelete(txt)">Delete</button>
      </li>
    </ul>
  </div>
</template>
